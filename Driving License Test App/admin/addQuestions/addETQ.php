...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `easyquestions`(question_number, text_) VALUES ('$question_number', '$question_text')";
    ...
    if ($run_query) { //number of the choice and $value is the value of the choice number
        foreach ($choices as $choice => $value) {
            if ($value != '') {
                ...
                //choice query
                $query = "INSERT INTO `easychoices` (question_number, is_correct, text_) VALUES ('$question_number','$is_correct','$value')";
                $run_query = $mysqli->query($query) or die($mysqli->error . __LINE__);
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <form action="addETQ.php" method="post">
