...
if (isset($_POST['submit'])) {
   ...
   // $question_image = $_POST['question_image'];
    ...
    if ($runimage_query) { //number of the choice and $value is the value of the choice number
...
<body>
    ...
    <main>
        <div class="container">
            <h2>Add A Quesetion to main exam</h2>
            ...
            <form action="addquestions.php" method="POST" enctype="multipart/form-data">
                ...
                <p> <label>Text:</label><input type="text" name="question_text">
                </p>
