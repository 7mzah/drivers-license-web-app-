...
$query = "SELECT * FROM `moderatequestions` WHERE  question_number = $number";
...
$query = "SELECT * FROM `moderatechoices` WHERE  question_number = $number";
            ...
            <form action="process.php" method="post">
                <ul class="choices">
                    <?php while($row = $choices->fetch_assoc()):?>
                        <li><input type="radio" name="choice" value="<?php echo $row['id']; ?>"><?php echo $row['text_'];?></li>
                    <?php endwhile; ?>
